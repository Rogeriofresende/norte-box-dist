---
description: "Apelido de /norte:vitrine (retrocompat). Gera a entrega como um arquivo HTML local auto-contido (CSS inline, zero rede) em ./norte-out/ e abre no navegador"
---
